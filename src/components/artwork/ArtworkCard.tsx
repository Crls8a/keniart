  ...
  const cardContent = (
    <>
      <div className="relative aspect-[4/5] overflow-hidden bg-[#17120e]">
        {image ? <ResponsiveArtworkImage image={image} alt={artwork.title} sizes={artworkImageSizes.card} className={`object-contain transition duration-700 motion-safe:group-hover:scale-[1.03] motion-safe:group-focus-visible:scale-[1.03] ${imagePadding}`} /> : null}
