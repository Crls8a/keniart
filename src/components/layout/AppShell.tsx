    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-30 border-b border-line/70 bg-background/90 backdrop-blur">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
          <Link href="/" className="font-serif text-xl tracking-[0.28em] uppercase">
            Keniart
          </Link>
          ...
          <Link
            href="/dossier"
            className="rounded-full border border-foreground px-4 py-2 text-xs uppercase tracking-[0.22em] transition hover:bg-foreground hover:text-background"
          >
            Dossier
          </Link>
        </nav>
      ...
      <footer className="border-t border-line px-5 py-10 text-sm text-muted sm:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-5">
            ...
            <Link href="/galerias" className="hover:text-foreground">
              Para galerias
            </Link>
          </div>
        </div>
