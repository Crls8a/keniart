    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link href="/obras" className="text-sm uppercase tracking-[0.22em] underline">
      ...
      <section className="border-y border-line bg-paper/60 px-5 py-20 sm:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-2">
          {series.map((item) => (
            <Link key={item.slug} href={`/series/${item.slug}`} className="group border border-line bg-background p-8 transition hover:-translate-y-1">
